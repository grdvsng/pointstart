...
Func _close($e=777)
   ...
   $errors[3] = "#3 The file is changed or incompatible with the program, launch is not possible, re-generate the shortcut."   $errors[4] = "#4 Для генерации ярлыка необходимы права Администратора."
